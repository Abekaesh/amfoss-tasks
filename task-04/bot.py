...
def getMovie(message):
    ...
    url = "http://www.omdbapi.com/?i=tt3896198&apikey={YOUR_KEY}&t={movie_name}".format(YOUR_KEY=YOUR_KEY,movie_name = movie_name)
    r = requests.get(url)
